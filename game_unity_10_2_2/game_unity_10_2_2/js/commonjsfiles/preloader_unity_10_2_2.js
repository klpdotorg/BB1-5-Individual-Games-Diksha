Game.preloader_unity_10_2_2 = function (game) {
	this.preloadBar = null;
};

Game.preloader_unity_10_2_2.prototype = {
	preload: function () {
		var basePath = window.baseUrl || '';

		// Game-specific assets (unity/10.2.2)
		...
		this.load.video('demo_unity_10_2_2', basePath + 'assets/demoVideos/10_2_2.mp4');
	...
	create: function () {
		...
		_this.src = null;
		function startGame() { _self.state.start('unity10_2_2level1'); }
		if (_self.cache.checkKey(Phaser.Cache.VIDEO, 'demo_unity_10_2_2')) {
			var vid = _self.add.video('demo_unity_10_2_2');
			vid.addToWorld(
			...
			vid.play(false);
			vid.changeSource(window.baseUrl + "assets/demoVideos/10_2_2.mp4");
			vid.play(false);
			vid.playbackRate = 1;
	...
	playDemoVideos: function (target) {
		...
		if (window.languageSelected == "Tamil") {
			try { _this.playQuestionSound.playbackRate = 1.3; } catch (e) { /* fallback if not supported */ }
		} else {
			_this.playQuestionSound.playbackRate = 1;
		}
