...
init:function(game)
    {
        ...
        telInitializer.gameIdInit("volume4_2C");
    ...
    var timebgNativeW = timebg.texture.frame.width;
    var timebgNativeH = timebg.texture.frame.height;
    timebg.anchor.setTo(0.5);
    timebg.x = timeDisplay.x;
    timebg.y = timeDisplay.y;
    fitTimebg = function(){
        var padX = 16;
        var scaleX = Math.max(1, (timeDisplay.width + padX) / timebgNativeW);
        var scaleY = _this.speakerbtn.height / timebgNativeH;
        timebg.scale.setTo(scaleX, scaleY);
    };
    fitTimebg();
    ...
    question2:function()
    {
        ...
        {
            _this.getVoice(qnoC);
            _his.time.events.add(1300,function(){
