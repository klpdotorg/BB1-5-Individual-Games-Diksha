Game.preloader_unity_1_4=function(game){
	this.preloadBar=null;
};

Game.preloader_unity_1_4.prototype={
	preload:function(){
		var basePath = window.baseUrl || '';

		// Game-specific assets (unity/1.4)
		this.load.atlas('unity1_4Tick', basePath+'assets/gradeAssets/unity/1.4/Tick.png', basePath+'assets/gradeAssets/unity/1.4/Tick.json');
		this.load.image('unity1_4BG_01', basePath+'assets/gradeAssets/unity/1.4/BG_01.png');
		this.load.image('unity1_4NumberKey', basePath+'assets/gradeAssets/unity/1.4/NumberKey.png');
		this.load.image('unity1_4practice',basePath+'assets/gradeAssets/unity/1.4/practice.png');
		this.load.image('unity1_4topic',basePath+'assets/gradeAssets/unity/1.4/topic.png');
		this.load.atlas('unity1_4backgrd', basePath+'assets/gradeAssets/unity/1.1/backgrd.png',basePath+'assets/gradeAssets/unity/1.1/backgrd.json');
		this.load.atlas('unity1_4ice_1', basePath+'assets/gradeAssets/unity/1.4/1.png', basePath+'assets/gradeAssets/unity/1.4/1.json');
		this.load.atlas('unity1_4flowe_aim', basePath+'assets/gradeAssets/unity/1.4/flowe_aim.png', basePath+'assets/gradeAssets/unity/1.4/flowe_aim.json');
		this.load.atlas('unity1_4ball_anim', basePath+'assets/gradeAssets/unity/1.4/ball_anim.png', basePath+'assets/gradeAssets/unity/1.4/ball_anim.json');
		this.load.atlas('unity1_4ice_anim', basePath+'assets/gradeAssets/unity/1.4/ice_anim.png', basePath+'assets/gradeAssets/unity/1.4/ice_anim.json');
		this.load.atlas('unity1_4ball_anim2', basePath+'assets/gradeAssets/unity/1.4/ball_anim2.png', basePath+'assets/gradeAssets/unity/1.4/ball_anim2.json');
		this.load.atlas('unity1_4flowe_aim2', basePath+'assets/gradeAssets/unity/1.4/flowe_aim2.png', basePath+'assets/gradeAssets/unity/1.4/flowe_aim2.json');
		...
		this.load.atlas('unity1_4starAnim', basePath+'assets/commonAssets/starAnim1.png', basePath+'assets/commonAssets/starAnim1.json');
		this.load.image('unity1_4navBar', basePath+'assets/commonAssets/topbar.png');
		this.load.image('unity1_4timebg', basePath+'assets/commonAssets/timebg.png');
		this.load.atlas('unity1_4CommonSpeakerBtn', basePath+'assets/commonAssets/grade11_speaker.png', basePath+'assets/commonAssets/grade11_speaker.json');
	...
	create:function(){
		this.state.start('unity1_4level1');
	},
};
