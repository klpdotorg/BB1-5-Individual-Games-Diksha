Game.preloader_unity_3_2_1 = function (game) {
	this.preloadBar = null;
};

Game.preloader_unity_3_2_1.prototype = {
	preload: function () {
		var basePath = window.baseUrl || '';

		// Game-specific assets (unity/3.2.1)
		...
		this.load.video('demo_unity_3_2_1', basePath + 'assets/demoVideos/3_2_1.mp4');
	...
	create: function () {
		...
		_this.src = null;
		function startGame() { _self.state.start('unity3_2_1level1'); }
		if (_self.cache.checkKey(Phaser.Cache.VIDEO, 'demo_unity_3_2_1')) {
			var vid = _self.add.video('demo_unity_3_2_1');
			vid.addToWorld(
			...
			vid.play(false);
			vid.changeSource(window.baseUrl + "assets/demoVideos/3_2_1.mp4");
			vid.play(false);
	...
	playDemoVideos: function (target) {
		...
		switch (target) {
			case '3_2_1a': if (window.languageSelected == "English") {
				_this.src.setAttribute("src", window.baseUrl + "assets/DemoVOs/English/3.2.1a.mp3");
			}
			else if (window.languageSelected == "Hindi") {
				_this.src.setAttribute("src", window.baseUrl + "assets/DemoVOs/Hindi/3.2.1a.mp3");
			}
			else if (window.languageSelected == "Kannada") {
				_this.src.setAttribute("src", window.baseUrl + "assets/DemoVOs/Kannada/3.2.1a.mp3");
			}
