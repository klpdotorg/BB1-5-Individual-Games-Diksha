...
Game.sg21_3_5level1.prototype={
    init:function(game)
	{
		...
		telInitializer.gameIdInit("SG23_1_5");
     ...
     getVoice:function(){
        ...
        switch(_this.qArrays[_this.qno])
        {
            case 1:if(window.languageSelected =="English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg21.3.5/Gujarati/sg21.3.5a.mp3");
            ...
            case 2:if(window.languageSelected =="English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg21.3.5/Gujarati/sg21.3.5b.mp3");
						//_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                    }
					else if(window.languageSelected =="Marathi")
                    {
            ...
            case 3:if(window.languageSelected =="English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg21.3.5/Gujarati/sg21.3.5c.mp3");
						//_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                    }
					else if(window.languageSelected =="Marathi")
                    {
            ...
            case 4:if(window.languageSelected =="English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg21.3.5/Gujarati/sg21.3.5d.mp3");
						//_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                    }
					else if(window.languageSelected =="Marathi")
                    {
            ...
            case 5:if(window.languageSelected =="English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg21.3.5/Gujarati/sg21.3.5e.mp3");
						//_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                    }
					else if(window.languageSelected =="Marathi")
                    {
            ...
            case 6:if(window.languageSelected =="English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg21.3.5/Gujarati/sg21.3.5f.mp3");
						//_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                    }
					else if(window.languageSelected =="Marathi")
                    {
            ...
            case 7:if(window.languageSelected =="English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg21.3.5/Gujarati/sg21.3.5g.mp3");
						//_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                    }
					else if(window.languageSelected =="Marathi")
                    {
            ...
            case 8:if(window.languageSelected =="English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg21.3.5/Gujarati/sg21.3.5h.mp3");
						//_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                    }
					else if(window.languageSelected =="Marathi")
                    {
            ...
            case 9:if(window.languageSelected =="English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg21.3.5/Gujarati/sg21.3.5i.mp3");
						//_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                    }
					else if(window.languageSelected =="Marathi")
                    {
            ...
            case 10:if(window.languageSelected =="English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg21.3.5/Gujarati/sg21.3.5j.mp3");
						//_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                    }
					else if(window.languageSelected =="Marathi")
                    {
