Game.preloader_pv3_5=function(game){
	this.preloadBar=null;
};

Game.preloader_pv3_5.prototype={
	preload:function(){
		var basePath = window.baseUrl || '';

		// Game-specific assets (pv3.5)
		...
		this.load.video('demo7_1_1', basePath+'assets/demoVideos/pv3.5.mp4');
	...
	create:function(){
		...
		_this.src = null;
		function startGame(){ _self.state.start('pv3_5level1'); }
		if (_self.cache.checkKey(Phaser.Cache.VIDEO, 'demo7_1_1')) {
			...
			vid.play(false);
			vid.changeSource(window.baseUrl+"assets/demoVideos/pv3.5.mp4");
			vid.play(false);
