Game.preloader_nsd5_5=function(game){
	this.preloadBar=null;
};

Game.preloader_nsd5_5.prototype={
	preload:function(){
		var basePath = window.baseUrl || '';

		// Game-specific assets (nsd5.5)
		this.load.image('nsd5_5background', basePath+'assets/gradeAssets/nsd5.5/Bg.png');
		this.load.atlas('nsd5_5_erase',basePath+'assets/gradeAssets/nsd5.5/erase.png' ,basePath+'assets/gradeAssets/nsd5.5/erase.json');
		...
		this.load.image('nsd5_5_numBG',basePath+'assets/gradeAssets/nsd5.5/b2.png');
		this.load.atlas('nsd5_5numberpad', basePath+'assets/gradeAssets/nsd5.5/calNum.png',basePath+'assets/gradeAssets/nsd5.5/calNum.json');
		this.load.atlas('nsd5_5tick', basePath+'assets/gradeAssets/nsd5.5/clickbtn.png',basePath+'assets/gradeAssets/nsd5.5/clickbtn.json');
		this.load.image('nsd5_5scorebox', basePath+'assets/gradeAssets/nsd5.5/Scorebox1.png');
		this.load.image('nsd5_5singleBar', basePath+'assets/gradeAssets/nsd5.5/singlebox.png');
		this.load.atlas('nsd5_5singleBar1',basePath+'assets/gradeAssets/nsd5.5/singlebox1.png',basePath+'assets/gradeAssets/nsd5.5/singlebox1.json');
		this.load.image('nsd5_5tensBar', basePath+'assets/gradeAssets/nsd5.5/TensBox.png');
		this.load.image('nsd5_5whiteBox', basePath+'assets/gradeAssets/nsd5.5/whitebox.png');
		this.load.atlas('nsd5_5grid',basePath+'assets/gradeAssets/nsd5.5/box10X10.png',basePath+'assets/gradeAssets/nsd5.5/box10X10.json');
		this.load.atlas('nsd5_5fractionscorebox', basePath+'assets/gradeAssets/nsd5.5/b1.png',basePath+'assets/gradeAssets/nsd5.5/b1.json');
		this.load.atlas('nsd5_5fractionscorebox2', basePath+'assets/gradeAssets/nsd5.5/fractionscorebox2.png',basePath+'assets/gradeAssets/nsd5.5/fractionscorebox2.json');
		this.load.image('nsd5_5divisionline', basePath+'assets/gradeAssets/nsd5.5/divisionline.png');
		...
		this.load.video('demo7_1_1', basePath+'assets/demoVideos/nsd5_5.mp4');
	...
	create:function(){
		...
		_this.src = null;
		function startGame(){ _self.state.start('nsd5_5level1'); }
		if (_self.cache.checkKey(Phaser.Cache.VIDEO, 'demo7_1_1')) {
			...
			vid.play(false);
			vid.changeSource(window.baseUrl+"assets/demoVideos/nsd5_5.mp4");
			vid.play(false);
	...
	playDemoVideos:function(target){
		...
		switch(target)
		{
			case 'nsd5_5': if(languageSelected == "English")
						{
