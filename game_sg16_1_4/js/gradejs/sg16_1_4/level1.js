...
Game.sg16_1_4level1.prototype={
    init:function(game)
	{
		...
		telInitializer.gameIdInit("SG16_1_4");
        ...
        switch(_this.qArrays[_this.no1])
        {
            case 1:
                   ...
                   if(window.languageSelected == "English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg16.1.4/Gujarati/sg16.1.4a.mp3");
                    }
                    ...
                    else if(window.languageSelected == "Odiya")
        {
            ...
            case 2:
                 if(window.languageSelected == "English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg16.1.4/Gujarati/sg16.1.4b.mp3");
                    }
					else if(window.languageSelected =="Marathi")
                    {
            ...
            case 3:
                if(window.languageSelected == "English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg16.1.4/Gujarati/sg16.1.4c.mp3");
                    }
					else if(window.languageSelected =="Marathi")
                    {
            ...
            case 4:
                if(window.languageSelected == "English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg16.1.4/Gujarati/sg16.1.4d.mp3");
                    }
					else if(window.languageSelected =="Marathi")
                    {
            ...
            case 5:
                if(window.languageSelected == "English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg16.1.4/Gujarati/sg16.1.4e.mp3");
                    }
					else if(window.languageSelected =="Marathi")
                    {
            ...
            case 6:
                if(window.languageSelected == "English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg16.1.4/Gujarati/sg16.1.4f.mp3");
                    }
					else if(window.languageSelected =="Marathi")
                    {
