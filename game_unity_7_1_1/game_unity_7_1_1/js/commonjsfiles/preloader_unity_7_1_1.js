Game.preloader_unity_7_1_1=function(game){
	this.preloadBar=null;
};

Game.preloader_unity_7_1_1.prototype={
	preload:function(){
		var basePath = window.baseUrl || '';

		// Game-specific assets (unity/7.1.1)
		...
		this.load.video('demo7_1_1', basePath+'assets/demoVideos/7_1_1.mp4');
	...
	create:function(){
		...
		_this.src = null;
		function startGame(){ _self.state.start('unity7_1_1level1'); }
		if (_self.cache.checkKey(Phaser.Cache.VIDEO, 'demo7_1_1')) {
			...
			vid.play(false);
			vid.changeSource(window.baseUrl+"assets/demoVideos/7_1_1.mp4");
			vid.play(false);
