Game.preloader_unity_17_3=function(game){
	this.preloadBar=null;
};

Game.preloader_unity_17_3.prototype={
	preload:function(){
		var basePath = window.baseUrl || '';

		// Game-specific assets (unity/17.3)
		...
		this.load.video('demo_unity_17_3', basePath+'assets/demoVideos/17_3.mp4');
	...
	create:function(){
		...
		_this.src = null;
		function startGame(){ _self.state.start('unity17_3level1'); }
		if (_self.cache.checkKey(Phaser.Cache.VIDEO, 'demo_unity_17_3')) {
			var vid = _self.add.video('demo_unity_17_3');
			vid.addToWorld(
			...
			vid.play(false);
			vid.changeSource(window.baseUrl+"assets/demoVideos/17_3.mp4");
			vid.play(false);
