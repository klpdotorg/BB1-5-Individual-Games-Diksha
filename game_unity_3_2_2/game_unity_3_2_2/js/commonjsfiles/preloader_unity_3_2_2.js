Game.preloader_unity_3_2_2 = function (game) {
	this.preloadBar = null;
};

Game.preloader_unity_3_2_2.prototype = {
	preload: function () {
		var basePath = window.baseUrl || '';

		// Game-specific assets (unity/3.2.2)
		...
		this.load.video('demo_unity_3_2_2', basePath + 'assets/demoVideos/3_2_2.mp4');
	...
	create: function () {
		...
		_this.src = null;
		function startGame() { _self.state.start('unity3_2_2level1'); }
		if (_self.cache.checkKey(Phaser.Cache.VIDEO, 'demo_unity_3_2_2')) {
			var vid = _self.add.video('demo_unity_3_2_2');
			vid.addToWorld(
			...
			vid.play(false);
			vid.changeSource(window.baseUrl + "assets/demoVideos/3_2_2.mp4");
			vid.play(false);
