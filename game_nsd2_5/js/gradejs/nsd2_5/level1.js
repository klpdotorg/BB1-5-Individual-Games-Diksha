...
Game.nsd2_5level1.prototype={
    init:function(game)
    {
        ...
        telInitializer.gameIdInit("NSD2_5");
...
//        _this.speaker.input.useHandCursor = true;
        ...
        console.log("getq"+(_this.no1<3 ? _this.qArrays[_this.no1] : _this.qArrays1[_this.no1-3]));
        if(_this.no1<3)
            {
         ...
         {
                        switch(_this.qArrays1[_this.no1-3])
                            {
        ...
        _this.playQuestionSound = document.createElement('audio');
         ...
         else
         {
          if(window.languageSelected == "English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/nsd2.5/Gujarati/nsd2.5b.mp3");
                    }
					else if(window.languageSelected =="Marathi")
                    {
