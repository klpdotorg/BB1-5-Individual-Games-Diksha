Game.preloader_unity_7_2_3=function(game){
	this.preloadBar=null;
};

Game.preloader_unity_7_2_3.prototype={
	preload:function(){
		var basePath = window.baseUrl || '';

		// Game-specific assets (unity/7.2.3)
		...
		this.load.video('demo7_1_1', basePath+'assets/demoVideos/7_2_3.mp4');
