Game.preloader_unity_10_2_1 = function (game) {
	this.preloadBar = null;
};

Game.preloader_unity_10_2_1.prototype = {
	preload: function () {
		var basePath = window.baseUrl || '';

		// Game-specific assets (unity/10.2.1)
		...
		this.load.video('demo_unity_10_2_1', basePath + 'assets/demoVideos/10_2_1.mp4');
	...
	create: function () {
		...
		_this.src = null;
		function startGame() { _self.state.start('unity10_2_1level1'); }
		if (_self.cache.checkKey(Phaser.Cache.VIDEO, 'demo_unity_10_2_1')) {
			var vid = _self.add.video('demo_unity_10_2_1');
			vid.addToWorld(
			...
			vid.play(false);
			vid.changeSource(window.baseUrl + "assets/demoVideos/10_2_1.mp4");
			vid.play(false);
