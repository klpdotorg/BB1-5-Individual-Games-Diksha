...
Game.grade1_2Clevel1.prototype = {
	...
	init: function (game) {
		...
		telInitializer.gameIdInit("pinwheel1_2C");
	...
	addFirstWindMill: function () {
		...
		_this.checkButton.events.onInputDown.add(function () {
			...
			_this.ClickSound = _this.add.audio('ClickSound');
			_this.ClickSound.play();
			_this.time.events.add(500, function () { _this.checkAns(); }, _this);
		}, _this);
	...
	getVoice: function () {
		...
		switch (_this.questionArray[_this.count - 1]) {
			...
			case 7: if (window.languageSelected == "English") {
				...
				_this.src.setAttribute("src", window.baseUrl + "questionSounds/1.2A/Marathi/1.2C1.mp3");
				_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
			}
			else if (window.languageSelected == "Tamil") {
				_this.src.setAttribute("src", window.baseUrl + "questionSounds/1.2A/Tamil/1.2C1.mp3");
				_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
			}
			else if (window.languageSelected == "Telugu") {
				_this.src.setAttribute("src", window.baseUrl + "questionSounds/1.2A/Telugu/1.2C1.mp3");
				_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
			}
			else if (window.languageSelected == "Urdu") {
				_this.src.setAttribute("src", window.baseUrl + "questionSounds/1.2A/Urdu/1.2C1.mp3");
				_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
			}
				break;
			case 2:
			...
			case 8: if (window.languageSelected == "English") {
				...
				_this.src.setAttribute("src", window.baseUrl + "questionSounds/1.2A/Marathi/1.2C2.mp3");
				_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
			}
			else if (window.languageSelected == "Tamil") {
				_this.src.setAttribute("src", window.baseUrl + "questionSounds/1.2A/Tamil/1.2C2.mp3");
				_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
			}
			else if (window.languageSelected == "Telugu") {
				_this.src.setAttribute("src", window.baseUrl + "questionSounds/1.2A/Telugu/1.2C2.mp3");
				_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
			}
			else if (window.languageSelected == "Urdu") {
				_this.src.setAttribute("src", window.baseUrl + "questionSounds/1.2A/Urdu/1.2C2.mp3");
				_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
			}
				break;
			case 3:
			...
			case 9: if (window.languageSelected == "English") {
				...
				_this.src.setAttribute("src", window.baseUrl + "questionSounds/1.2A/Marathi/1.2C3.mp3");
				_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
			}
			else if (window.languageSelected == "Tamil") {
				_this.src.setAttribute("src", window.baseUrl + "questionSounds/1.2A/Tamil/1.2C3.mp3");
				_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
			}
			else if (window.languageSelected == "Telugu") {
				_this.src.setAttribute("src", window.baseUrl + "questionSounds/1.2A/Telugu/1.2C3.mp3");
				_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
			}
			else if (window.languageSelected == "Urdu") {
				_this.src.setAttribute("src", window.baseUrl + "questionSounds/1.2A/Urdu/1.2C3.mp3");
				_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
			}
				break;
