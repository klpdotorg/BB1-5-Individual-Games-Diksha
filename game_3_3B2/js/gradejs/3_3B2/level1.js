...
Game.grade3_3B2level1.prototype = {
    ...
    init: function (game) {
        ...
        telInitializer.gameIdInit("weight3_3B2");


        if (typeof window.languageSelected === "undefined" || !window.languageSelected) {
            window.languageSelected = "Tamil";
        }
        if (typeof window.grade2Selected === "undefined") {
            window.grade2Selected = false;
        }
        _this.currentTranscriptVideo = null;
        _this.currentTranscriptVideoWorld = null;
    ...
    create: function (game) {
        ...
        /* var backbtn = this.add.button(5,1,'CommonBackBtn',function(){
               this.stopAllVoice();
                  enterTxt.setText(""); fitEnterTxt();
                  enterTxt2.setText(""); fitEnterTxt2();
                  selectedAns="";
                  selectedAns2="";
        ...
        _this.timebgNativeW = _this.timebg.texture.frame.width;
        _this.timebgNativeH = _this.timebg.texture.frame.height;
        _this.timebg.anchor.setTo(0.5);
        _this.timebg.x = _this.timeDisplay.x;
        _this.timebg.y = _this.timeDisplay.y;
        _this.fitTimebg = function(){
            var padX = 16;
            var scaleX = Math.max(1, (_this.timeDisplay.width + padX) / _this.timebgNativeW);
            var scaleY = _this.speakerbtn.height / _this.timebgNativeH;
            _this.timebg.scale.setTo(scaleX, scaleY);
        };
        _this.fitTimebg();
    ...
    addNumberPad: function () {
        ...
        txtboxNativeW = txtbox.texture.frame.width;
        txtboxNativeH = txtbox.texture.frame.height;
        fitEnterTxt = function () {
            enterTxt.fontSize = 30;
            var maxW = txtboxNativeW * 0.82;
            var maxH = txtboxNativeH * 0.82;
            while ((enterTxt.width > maxW || enterTxt.height > maxH) && enterTxt.fontSize > 10) {
                enterTxt.fontSize -= 1;
            }
        };
        fitEnterTxt();
        ...
        txtbox2NativeW = txtbox2.texture.frame.width;
        txtbox2NativeH = txtbox2.texture.frame.height;
        fitEnterTxt2 = function () {
            enterTxt2.fontSize = 30;
            var maxW = txtbox2NativeW * 0.82;
            var maxH = txtbox2NativeH * 0.82;
            while ((enterTxt2.width > maxW || enterTxt2.height > maxH) && enterTxt2.fontSize > 10) {
                enterTxt2.fontSize -= 1;
            }
        };
        fitEnterTxt2();
        ...
        rightbtn.events.onInputDown.add(function (target) {
            ...
            if ((selectedAns == rightAns || selectedAns == "0" + rightAns || selectedAns == "00" + rightAns) && (selectedAns2 == rightAns2 || selectedAns2 == "0" + rightAns2 || selectedAns2 == "00" + rightAns2)) {
                ...
                this.time.events.add(500, function () {
                    ...
                    obj2Group.getByName('50g33').events.onInputDown.add(function (target) {
                        this.telemetry(target);
                    ...
                    obj2Group.getByName('100g33').events.onInputDown.add(function (target) {
                        this.telemetry(target);
                    ...
                    obj2Group.getByName('200g33').events.onInputDown.add(function (target) {
                        this.telemetry(target);
                    ...
                    obj2Group.getByName('500g33').events.onInputDown.add(function (target) {
                        this.telemetry(target);
                    ...
                    obj2Group.getByName('1kg33').events.onInputDown.add(function (target) {
                        this.telemetry(target);
                    ...
                    obj2Group.getByName('2kg33').events.onInputDown.add(function (target) {
                        this.telemetry(target);
                    ...
                    obj2Group.getByName('5kg33').events.onInputDown.add(function (target) {
                        this.telemetry(target);
                    ...
                    obj2Group.getByName('10kg33').events.onInputDown.add(function (target) {
                        this.telemetry(target);
    ...
    gotoFirstQuestion: function () {
        ...
        if (no1 == 0) {
            ...
            this.time.events.add(timelang, function () {
                ...
                object6.events.onInputDown.add(function (target) {
                    this.telemetry(target);
                    oneKgAngle = 1;
                    oneKgWeight = 2;
                ...
                object7.events.onInputDown.add(function (target) {
                    this.telemetry(target);
                    twoKgAngle = 1;
                    twoKgWeight = 2;
                    this.objectClicked(target, 2, 1);
                ...
                object8.events.onInputDown.add(function (target) {
                    this.telemetry(target);
                    fiveKgAngle = 4;
                    fiveKgWeight = 11;
                ...
                object9.events.onInputDown.add(function (target) {
                    this.telemetry(target);
                    tenKgAngle = 4.5;
                    tenKgWeight = 13;
    ...
    stopDragging1: function (target) {
        ...
        if (this.checkOverlap(target, weightScale4.getChildAt(0))) {
            ...
            tweenVal = this.t1;
            angleVal = this.t2;
            scale2Group.getByName(tempName).events.onInputDown.add(function (target) {
                this.telemetry(target);
                // console.log(target.name);
    ...
    dragStopping2: function (target) {
        ...
        if (this.checkOverlap(target, objGroup.getByName("graphics2"))) {
            ...
            tweenVal = this.t1;
            angleVal = this.t2;
            obj2Group.getByName(tempName).events.onInputDown.add(function (target) {
                this.telemetry(target);
