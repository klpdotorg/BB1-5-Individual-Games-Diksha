...
Game.sg24_1_4level1.prototype={
    init:function(game)
	{
		...
		telInitializer.gameIdInit("SG24_1_4");
    ...
    {   
        ...
        switch(_this.qArrays[_this.qno])
        {
            ...
            case 7:if(window.languageSelected == "English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg24.1.4/Gujarati/sg24.1.4.mp3");
            ...
            case 12:if(window.languageSelected == "English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg24.1.4/Gujarati/sg24.1.4a.mp3");
						//_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                    }
					else if(window.languageSelected =="Marathi")
                    {
