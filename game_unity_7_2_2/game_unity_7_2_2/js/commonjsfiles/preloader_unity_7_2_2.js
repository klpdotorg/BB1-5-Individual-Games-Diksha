Game.preloader_unity_7_2_2=function(game){
	this.preloadBar=null;
};

Game.preloader_unity_7_2_2.prototype={
	preload:function(){
		var basePath = window.baseUrl || '';

		// Game-specific assets (unity/7.2.2)
		...
		this.load.video('demo7_1_1', basePath+'assets/demoVideos/7_2_2.mp4');
	...
	create:function(){
		...
		_this.src = null;
		function startGame(){ _self.state.start('unity7_2_2level1'); }
		if (_self.cache.checkKey(Phaser.Cache.VIDEO, 'demo7_1_1')) {
			...
			vid.changeSource(window.baseUrl+"assets/demoVideos/7_2_2.mp4");
			vid.play(false);
