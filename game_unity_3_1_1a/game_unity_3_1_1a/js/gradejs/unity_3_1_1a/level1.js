...
Game.unity3_1_1alevel1.prototype={
    ...
    {
       _this = this;
       telInitializer.gameIdInit("unity3_1_1a");
...
numberBoxClicked:function(target){
    ...
    if( _this.toCheckNumberPad && _this.correct >= _this.cube)
        {
             _this.toCheckNumberPad = false;
...
numClicked:function(target){
  ...
  wrongAns:function(target)
    ...
    getVoice:function(){
        ...
        var _playPromise = _this.playQuestionSound.play();
        if (_playPromise !== undefined) {
            _playPromise.catch(function() {
                _this.pendingAutoplayAudio = _this.playQuestionSound;
                _this.pendingAutoplayHandler = function() {
                    if (_this.pendingAutoplayAudio) {
                        _this.pendingAutoplayAudio.play().catch(function(){});
                        _this.pendingAutoplayAudio = null;
                        _this.pendingAutoplayHandler = null;
                    }
                };
                document.addEventListener('click',      _this.pendingAutoplayHandler, { once: true });
                document.addEventListener('touchstart', _this.pendingAutoplayHandler, { once: true });
            });
        }
    },
