    ...
    getVoice:function(){
        ...
        switch(_this.qArrays[_this.no11])
        {
            ...
            case 8:if(window.languageSelected =="English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg23.1.5/Gujarati/sg23.1.5a.mp3");
            ...
            case 7: if(window.languageSelected =="English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg23.1.5/Gujarati/sg23.1.5b.mp3");
                        //_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                    }
					else if(window.languageSelected =="Marathi")
                    {
            ...
            case 10:if(window.languageSelected =="English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg23.1.5/Gujarati/sg23.1.5c.mp3");
                        //_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                    }
					else if(window.languageSelected =="Marathi")
                    {
