...
Game.unity7_2_1level1.prototype={
     ...
     init:function(game)
    {
        ...
        telInitializer.gameIdInit("CoinMachine7_2_1");
	...
	create:function(game){
        ...
        _this.selectedAns3 = "";
        _this.rightAns = "";
        _this.prevDisplayNumber1 = -1;
        _this.prevDisplayNumber2 = -1;
        randarr = new Array();
     ...
     _this.yellowcoin=_this.add.sprite(0,0,'Level721_Coin1');
      ...
      //  _this.timer = _this.time.create(false);
       ...
       /**************************************************************************/ 
        ...
        var _maxAttempts = 10;
        while (_this.displayNumber1 === _this.prevDisplayNumber1 && _this.displayNumber2 === _this.prevDisplayNumber2 && _maxAttempts-- > 0) {
            _this.qArrays = _this.shuffle( _this.qArrays);
            _this.qArrays2 = _this.shuffle( _this.qArrays2);
            _this.displayNumber1 = _this.qArrays[0];
            _this.displayNumber2 = _this.qArrays2[0];
        }
        _this.prevDisplayNumber1 = _this.displayNumber1;
        _this.prevDisplayNumber2 = _this.displayNumber2;
