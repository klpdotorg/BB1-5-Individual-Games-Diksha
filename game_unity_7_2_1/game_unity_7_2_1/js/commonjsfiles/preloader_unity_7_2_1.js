Game.preloader_unity_7_2_1=function(game){
	this.preloadBar=null;
};

Game.preloader_unity_7_2_1.prototype={
	preload:function(){
		var basePath = window.baseUrl || '';

		// Game-specific assets (unity/7.2.1)
		...
		this.load.video('demo_unity_7_2_1', basePath+'assets/demoVideos/7_2_1.mp4');
	...
	create:function(){
		...
		if (_self.cache.checkKey(Phaser.Cache.VIDEO, 'demo_unity_7_2_1')) {
			var vid = _self.add.video('demo_unity_7_2_1');
			vid.addToWorld(
