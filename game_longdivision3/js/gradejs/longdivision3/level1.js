...
Game.longdivision3.prototype = {
    ...
    create: function (game) {
        ...
        _this.fitTimebg = function () {
            ...
            var scaleY = _this.speaker.height / _this.timebgNativeH;
    ...
    getVoice: function () {
        ...
        if (_this.voice1 == 1) {
            if (window.languageSelected == "English") {
                ...
                _this.src.setAttribute("src", window.baseUrl + "questionSounds/DH2/Gujarati/dhdtg1.4_1.mp3");
            }
            ...
            if (window.languageSelected == "English") {
                ...
                _this.src.setAttribute("src", window.baseUrl + "questionSounds/DH2/Gujarati/dhdtg1.4_2.mp3");
            }
            else if (window.languageSelected == "Marathi") {
            ...
            if (window.languageSelected == "English") {
                ...
                _this.src.setAttribute("src", window.baseUrl + "questionSounds/DH2/Gujarati/which_is_least.mp3");
            }
            else if (window.languageSelected == "Marathi") {
            ...
            if (window.languageSelected == "English") {
                ...
                _this.src.setAttribute("src", window.baseUrl + "questionSounds/DH2/Gujarati/Which_are_most.mp3");
            }
            else if (window.languageSelected == "Marathi") {
