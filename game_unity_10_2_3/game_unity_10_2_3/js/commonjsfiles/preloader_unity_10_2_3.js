Game.preloader_unity_10_2_3 = function (game) {
	this.preloadBar = null;
};

Game.preloader_unity_10_2_3.prototype = {
	preload: function () {
		var basePath = window.baseUrl || '';

		// Game-specific assets (unity/10.2.3)
		...
		this.load.video('demo_unity_10_2_3', basePath + 'assets/demoVideos/10_2_3.mp4');
	...
	create: function () {
		...
		_this.src = null;
		function startGame() { _self.state.start('unity10_2_3level1'); }
		if (_self.cache.checkKey(Phaser.Cache.VIDEO, 'demo_unity_10_2_3')) {
			var vid = _self.add.video('demo_unity_10_2_3');
			vid.addToWorld(
			...
			vid.play(false);
			vid.changeSource(window.baseUrl + "assets/demoVideos/10_2_3.mp4");
			vid.play(false);
			if (window.languageSelected == "Gujarati") {
				...
				vid.playbackRate = 1;
				_this.time.events.add(2000, function () {
					if (window.languageSelected == "Telugu" || window.languageSelected == "Tamil" || window.languageSelected == "Urdu" || window.languageSelected == "Marathi") {
