...
Game.sg15_2_3level1.prototype={
    init:function(game)
    {
       ...
       telInitializer.gameIdInit("SG15_2_3");
...
create:function(game)
    {
        ...
        if(window.languageSelected =="English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg15.2.3/Gujarati/sg15.2.3a.mp3");
    ...
    getVoice:function(){
        ...
        {             
            case 1:if(window.languageSelected =="English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg15.2.3/Gujarati/sg15.2.3b.mp3");
                       // _this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                    }
					else if(window.languageSelected =="Marathi")
                    {
            ...
            case 2:if(window.languageSelected =="English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg15.2.3/Gujarati/sg15.2.3c.mp3");
                        //_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                    }
					else if(window.languageSelected =="Marathi")
                    {
            ...
            case 3:if(window.languageSelected =="English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg15.2.3/Gujarati/sg15.2.3d.mp3");
                        //_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                    }
					else if(window.languageSelected =="Marathi")
                    {
            ...
            case 4:if(window.languageSelected =="English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg15.2.3/Gujarati/sg15.2.3e.mp3");
                        //_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                    }
					else if(window.languageSelected =="Marathi")
                    {
            ...
            case 5:if(window.languageSelected =="English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg15.2.3/Gujarati/sg15.2.3f.mp3");
                        //_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                    }
					else if(window.languageSelected =="Marathi")
                    {
            ...
            case 6:if(window.languageSelected =="English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg15.2.3/Gujarati/sg15.2.3g.mp3");
                        //_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                    }
					else if(window.languageSelected =="Marathi")
                    {
            ...
            case 7:if(window.languageSelected =="English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg15.2.3/Gujarati/sg15.2.3h.mp3");
                        //_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                    }
					else if(window.languageSelected =="Marathi")
                    {
            ...
            case 8:if(window.languageSelected =="English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg15.2.3/Gujarati/sg15.2.3i.mp3");
                        //_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                    }
					else if(window.languageSelected =="Marathi")
                    {
