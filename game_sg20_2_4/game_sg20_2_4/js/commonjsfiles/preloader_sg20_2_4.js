Game.preloader_sg20_2_4=function(game){
	this.preloadBar=null;
};

Game.preloader_sg20_2_4.prototype={
	preload:function(){
		var basePath = window.baseUrl || '';

		// Game-specific assets (sg20.2.4)
		this.load.atlas("sg20_2_4_image_anim1",basePath+"assets/gradeAssets/sg20.2.4/1.png",basePath+"assets/gradeAssets/sg20.2.4/1.json");
		this.load.atlas("sg20_2_4_image_anim2",basePath+"assets/gradeAssets/sg20.2.4/2.png",basePath+"assets/gradeAssets/sg20.2.4/2.json");
		this.load.atlas("sg20_2_4_image_anim3",basePath+"assets/gradeAssets/sg20.2.4/3.png",basePath+"assets/gradeAssets/sg20.2.4/3.json");
		this.load.atlas("sg20_2_4_image_anim4",basePath+"assets/gradeAssets/sg20.2.4/4.png",basePath+"assets/gradeAssets/sg20.2.4/4.json");
		this.load.atlas("sg20_2_4_image_anim5",basePath+"assets/gradeAssets/sg20.2.4/5.png",basePath+"assets/gradeAssets/sg20.2.4/5.json");
		this.load.atlas("sg20_2_4_image_anim6",basePath+"assets/gradeAssets/sg20.2.4/6.png",basePath+"assets/gradeAssets/sg20.2.4/6.json");
		this.load.atlas("sg20_2_4_image_anim7",basePath+"assets/gradeAssets/sg20.2.4/7.png",basePath+"assets/gradeAssets/sg20.2.4/7.json");
		this.load.atlas("sg20_2_4_image_anim8",basePath+"assets/gradeAssets/sg20.2.4/8.png",basePath+"assets/gradeAssets/sg20.2.4/8.json");
		this.load.atlas("sg20_2_4_image_anim9",basePath+"assets/gradeAssets/sg20.2.4/9.png",basePath+"assets/gradeAssets/sg20.2.4/9.json");
		this.load.atlas("sg20_2_4_image_anim10",basePath+"assets/gradeAssets/sg20.2.4/10.png",basePath+"assets/gradeAssets/sg20.2.4/10.json");
		this.load.atlas("sg20_2_4_image_anim11",basePath+"assets/gradeAssets/sg20.2.4/11.png",basePath+"assets/gradeAssets/sg20.2.4/11.json");
		this.load.atlas("sg20_2_4_image_anim12",basePath+"assets/gradeAssets/sg20.2.4/12.png",basePath+"assets/gradeAssets/sg20.2.4/12.json");
		this.load.image("sg20_2_4_Pencil",basePath+"assets/gradeAssets/sg20.2.4/pencil.png");
		this.load.image("sg20_2_4_Eraser",basePath+"assets/gradeAssets/sg20.2.4/eraser.png");
		this.load.image("sg20_2_4_Board",basePath+"assets/gradeAssets/sg20.2.4/Board.png");
		this.load.atlas("sg20_2_4_TickMark",basePath+"assets/gradeAssets/sg20.2.4/tick.png",basePath+"assets/gradeAssets/sg20.2.4/tick.json");
	...
	create:function(){
		this.state.start('sg20_2_4level1');
	},
};
