...
Game.sg20_1_4level1.prototype={
    init:function(game)
    {
       ...
       telInitializer.gameIdInit("SG20_1_4");
    ...
    getVoice:function(){
        ...
        switch(_this.qArrays[_this.no11])
        {
            ...
            if(window.languageSelected =="English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg20.1.4/Gujarati/sg20.1.4a.mp3");
            ...
            if(window.languageSelected =="English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg20.1.4/Gujarati/sg20.1.4b.mp3");
                        //_this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
                    }
					else if(window.languageSelected =="Marathi")
                    {
