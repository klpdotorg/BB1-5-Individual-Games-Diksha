...
Game.grade6_1level1.prototype = {
    init: function (game) {
        ...
        telInitializer.gameIdInit("time6_1");
    ...
    preload: function (game) {
        if (!window.grade2MT1) {
            ...
            if (window.languageSelected == "Marathi" || window.languageSelected == "Telugu" || window.languageSelected == "Tamil" || window.languageSelected == "Urdu")
                this.load.atlas('Level61_months', 'assets/newAssets/monthname.png', 'assets/newAssets/monthname.json');
            else
                this.load.atlas('Level61_months', 'assets/newAssets/monthname1.png', 'assets/newAssets/monthname1.json');
            ...
            if (window.languageSelected == "Tamil")
                this.load.atlas('Level61_wednesday', 'assets/newAssets/3_1.png', 'assets/newAssets/3_1.json');
            else
    ...
    getVoice: function () {
        ...
        switch (voices[0]) {
            ...
            case "Thursday": if (window.languageSelected == "English") {
                ...
                _this.src.setAttribute("src", window.baseUrl + "questionSounds/6.1/Tamil/EThursday.mp3");
            }
            else if (window.languageSelected == "Urdu") {
