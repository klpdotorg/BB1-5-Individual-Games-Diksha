...
Game.sg7_2_2level1.prototype = {
  init: function (game) {
    ...
    telInitializer.gameIdInit("SG7_2_2");
    ...
    switch (_this.qArrays[_this.no1]) {
      ...
      case 5:
        if (window.languageSelected == "English") {
          ...
          _this.src.setAttribute("src", window.baseUrl + "questionSounds/sg7.2.2/Gujarati/sg7.2.2c.mp3");
        }
      ...
      case 7:
        if (window.languageSelected == "English") {
          ...
          _this.src.setAttribute("src", window.baseUrl + "questionSounds/sg7.2.2/Gujarati/sg7.2.2a.mp3");
        }
        else if (window.languageSelected == "Marathi") {
      ...
      case 10:
        if (window.languageSelected == "English") {
          ...
          _this.src.setAttribute("src", window.baseUrl + "questionSounds/sg7.2.2/Gujarati/sg7.2.2b.mp3");
        }
        else if (window.languageSelected == "Marathi") {
