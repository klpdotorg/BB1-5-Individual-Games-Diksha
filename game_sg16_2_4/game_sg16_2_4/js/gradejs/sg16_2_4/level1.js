...
Game.sg16_2_4level1.prototype={
    init:function(game)
	{
		...
		telInitializer.gameIdInit("SG16_2_4");
        ...
        switch(_this.questionArrayMain[_this.no1])
        {
            ...
            case 2:
                 if(window.languageSelected == "English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg16.2.4/Gujarati/sg16.2.4d.mp3");
                    }
                    ...
                    else if(window.languageSelected == "Odiya")
        {
            ...
            case 3:
                if(window.languageSelected == "English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg16.2.4/Gujarati/sg16.2.4a.mp3");
                    }
					else if(window.languageSelected =="Marathi")
                    {
            ...
            case 5:
                if(window.languageSelected == "English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg16.2.4/Gujarati/sg16.2.4c.mp3");
                    }
					else if(window.languageSelected =="Marathi")
                    {
            ...
            case 6:
                if(window.languageSelected == "English")
                    ...
                    {
                        _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg16.2.4/Gujarati/sg16.2.4b.mp3");
                    }
					else if(window.languageSelected =="Marathi")
                    {
