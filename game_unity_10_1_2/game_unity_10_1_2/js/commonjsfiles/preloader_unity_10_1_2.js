Game.preloader_unity_10_1_2 = function (game) {
	this.preloadBar = null;
};

Game.preloader_unity_10_1_2.prototype = {
	preload: function () {
		var basePath = window.baseUrl || '';

		// Game-specific assets (unity/10.1.2)
		...
		this.load.video('demo7_1_1', basePath + 'assets/demoVideos/10_1_2.mp4');
	...
	create: function () {
		...
		_this.src = null;
		function startGame() { _self.state.start('unity10_1_2level1'); }
		if (_self.cache.checkKey(Phaser.Cache.VIDEO, 'demo7_1_1')) {
			...
			vid.play(false);
			vid.changeSource(window.baseUrl + "assets/demoVideos/10_1_2.mp4");
			vid.play(false);
			vid.playbackRate = 1;
