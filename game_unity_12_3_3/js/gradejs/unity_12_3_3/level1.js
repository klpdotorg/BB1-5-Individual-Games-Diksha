...
Game.unity12_3_3level1.prototype ={
    ...
    {
       _this= this;
       telInitializer.gameIdInit("multiplication12_3_1");
	...
	create:function(game)
    {
        ...
        _this.questionOptions = _this.shuffle(_this.questionOptions);
    ...
    getQuestion:function(target)
    {
        ...
        var qInfo = _this.questionOptions[_this.no11];
        _this.randomno = qInfo.a;
        _this.questionSecond = qInfo.b;
    ...
    addNumberPad:function()
    {
        ...
        if(_this.questionSecond != null)
        {
            _this.framesChange1 = [_this.questionSecond];
        }
        else
        {
