...
init:function(game)
    {
       ...
       telInitializer.gameIdInit("SG7_1_2");
		  ...
		  _this.src = document.createElement('source');
            switch(_this.temp)
            {
                ...
                case 10:if(window.languageSelected == "English")
                            ...
                            {
                                _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg7.1.2/Gujarati/sg7.1.2a.mp3");
                            }
                ...
                case 11: if(window.languageSelected == "English")
                            ...
                            {
                                _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg7.1.2/Gujarati/sg7.1.2d.mp3");
                            }
							else if(window.languageSelected =="Marathi")
                    {
                ...
                case 13:if(window.languageSelected == "English")
                            ...
                            {
                                _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg7.1.2/Gujarati/sg7.1.2b.mp3");
                            }
							else if(window.languageSelected =="Marathi")
                    {
                ...
                case 15:if(window.languageSelected == "English")
                            ...
                            {
                                _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg7.1.2/Gujarati/sg7.1.2f.mp3");
                            }
							else if(window.languageSelected =="Marathi")
                    {
                ...
                case 17:if(window.languageSelected == "English")
                            ...
                            {
                                _this.src.setAttribute("src", window.baseUrl+"questionSounds/sg7.1.2/Gujarati/sg7.1.2c.mp3");
                            }
							else if(window.languageSelected =="Marathi")
                    {
