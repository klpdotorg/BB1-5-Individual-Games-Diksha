Game.preloader_pv1_5=function(game){
	this.preloadBar=null;
};

Game.preloader_pv1_5.prototype={
	preload:function(){
		var basePath = window.baseUrl || '';

		// Game-specific assets (pv1.5)
		...
		this.load.video('demo7_1_1', basePath+'assets/demoVideos/pv1.5.mp4');
	...
	create:function(){
		...
		_this.src = null;
		function startGame(){ _self.state.start('pv1_5level1'); }
		if (_self.cache.checkKey(Phaser.Cache.VIDEO, 'demo7_1_1')) {
			...
			vid.play(false);
			vid.changeSource(window.baseUrl+"assets/demoVideos/pv1.5.mp4");
			vid.play(false);
