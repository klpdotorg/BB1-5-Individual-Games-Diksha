Game.preloader_unity_3_1_1=function(game){
	this.preloadBar=null;
};

Game.preloader_unity_3_1_1.prototype={
	preload:function(){
		var basePath = window.baseUrl || '';

		// Game-specific assets (unity/3.1.1)
		...
		this.load.video('demo_unity_3_1_1', basePath+'assets/demoVideos/3_1_1.mp4');
	...
	create:function(){
		...
		_this.src = null;
		function startGame(){ _self.state.start('unity3_1_1level1'); }

		if (_self.cache.checkKey(Phaser.Cache.VIDEO, 'demo_unity_3_1_1')) {
			var vid = _self.add.video('demo_unity_3_1_1');
			vid.addToWorld(
			...
			vid.play(false);
			vid.changeSource(window.baseUrl+"assets/demoVideos/3_1_1.mp4");
			vid.play(false);
			_this.playDemoVideos('3_1_1');
	...
	playDemoVideos:function(target){
		...
		switch(target)
		{
			case '3_1_1':  if(window.languageSelected == "English")
							{
							...
							{
								_this.src.setAttribute("src", "questionSounds/3.2.1/Tamil/3.1.1.mp3");
								// _this.amplify = this.amplifyMedia(_this.playQuestionSound, 3);
							}
							break;
		}
