Game.preloader_unity_7_1_3=function(game){
	this.preloadBar=null;
};

Game.preloader_unity_7_1_3.prototype={
	preload:function(){
		var basePath = window.baseUrl || '';

		// Game-specific assets (unity/7.1.3)
		...
		this.load.video('demo7_1_1', basePath+'assets/demoVideos/7_1_3.mp4');
	...
	create:function(){
		...
		_this.src = null;
		function startGame(){ _self.state.start('unity7_1_3level1'); }
